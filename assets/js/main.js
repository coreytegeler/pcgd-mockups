$(function() {
	...
	function zoomIn(pageName) {
		...
		if($('body').hasClass('locked')) {
			...
			$('#editor').css({
				'-webkit-transform':'-webkit-translateY('+editTop+'px)',
				'-moz-transform':'-moz-translateY('+editTop+'px)',
    			'-ms-transform':'-ms-translateY('+editTop+'px)',
   				'transform':'translateY('+editTop+'px)',
				'height':editHeight,
			});
		}
